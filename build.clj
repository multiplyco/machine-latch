...
(def lib 'co.multiply/machine-latch)
(def version "0.1.15")
...
(def scm-url "https://github.com/multiplyco/machine-latch")
...
(defn deploy [_]
  ...
  (deploy/deploy {:installer  :remote
                  :artifact   jar-file
                  :pom-file   (str class-dir "/META-INF/maven/co.multiply/machine-latch/pom.xml")
